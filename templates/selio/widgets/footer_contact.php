...
<div class="col-xl-3 col-sm-6 col-md-3 widget_edit_enabled">
    <div class="widget-footer-contacts">
        ...
        <ul class="footer-list">                
            ...
            <span class="value"><a href="https://maps.google.com/maps?q=<?php echo urlencode(lang_check('432 Park Ave, New York, NY 10022')); ?>" target="_blank" title="<?php echo lang_check('View on Google Maps'); ?>"><?php echo lang_check('432 Park Ave, New York, NY 10022'); ?></a></span></li>
