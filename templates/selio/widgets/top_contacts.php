        ...
        <div class="row justify-content-center row-contact">
            <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
                <div class="contact-card">
                    ...
                    <div class="address"><a href="https://maps.google.com/maps?q=<?php echo urlencode('{settings_address}'); ?>" target="_blank" title="<?php echo lang_check('View on Google Maps'); ?>">{settings_address}</a></div>
                </div><!--card end-->
            </div>
            <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
                <div class="contact-card">
                    <div class="contact_info">
                        ...
                        <ul class="cont_info">
                            <li><i class="la la-map-marker"></i> <span class="address"><a href="https://maps.google.com/maps?q=<?php echo urlencode('{settings_address}'); ?>" target="_blank" title="<?php echo lang_check('View on Google Maps'); ?>">{settings_address}</a></span></li>
